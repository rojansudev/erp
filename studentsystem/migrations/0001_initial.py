# Generated by Django 3.1 on 2020-09-08 05:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_type', models.CharField(db_column='Section_type', max_length=3)),
                ('location', models.CharField(blank=True, db_column='Location', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(db_column='Course_id', on_delete=django.db.models.deletion.DO_NOTHING, to='studentsystem.course')),
                ('student', models.ForeignKey(db_column='Student_id', on_delete=django.db.models.deletion.DO_NOTHING, to='studentsystem.student')),
            ],
            options={
                'db_table': 'Enroll',
